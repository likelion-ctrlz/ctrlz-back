...
_FALLBACK_PROGRAMS = [
    {
        "title": "서예 입문 클래스",
        "agency_name": "강동구 문화예술회관",
        "region": "서울 강동구",
        "description": "붓과 먹으로 한 글자씩 써 내려가는 시간이에요. 서예를 통해 집중하고 나만의 속도를 표현하는 경험을 나눠볼 수 있어요.",
        "image_url": "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.gangdong.go.kr",
    },
    {
        "title": "도자기 원데이 공방",
        "agency_name": "마포구민 문화센터",
        "region": "서울 마포구",
        "description": "손으로 흙을 빚어 나만의 그릇을 만들어보는 시간이에요. 초보자도 강사와 함께 처음부터 차근차근 진행할 수 있어요.",
        "image_url": "https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.mapo.go.kr",
    },
    {
        "title": "실내 텃밭 가꾸기 교실",
        "agency_name": "은평구립 평생학습관",
        "region": "서울 은평구",
        "description": "작은 화분에 씨앗을 심고 가꾸는 법을 배우는 모임이에요. 말을 많이 하지 않아도 괜찮은, 흙을 만지는 시간 자체가 목적이에요.",
        "image_url": "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.ep.go.kr",
    },
    {
        "title": "아침 스트레칭 교실",
        "agency_name": "노원구 문화복지센터",
        "region": "서울 노원구",
        "description": "앉거나 누운 채로도 할 수 있는 가벼운 스트레칭 위주로 진행돼요. 체력이 부담스러워도 본인 속도로 편하게 따라가면 돼요.",
        "image_url": "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.nowon.kr",
    },
    {
        "title": "캘리그라피 원데이클래스",
        "agency_name": "성동구 문화의집",
        "region": "서울 성동구",
        "description": "펜과 잉크로 한 글자 한 글자 정성껏 써보는 시간이에요. 처음이어도 괜찮아요, 삐뚤빼뚤한 글씨도 나만의 개성이 될 수 있어요.",
        "image_url": "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.sd.go.kr",
    },
    {
        "title": "홈베이킹 클래스",
        "agency_name": "송파구립 도서관",
        "region": "서울 송파구",
        "description": "반죽부터 굽기까지 처음부터 끝까지 직접 만들어보는 클래스예요. 서툴러도 괜찮아요, 완성된 빵을 직접 맛보는 재미가 있어요.",
        "image_url": "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.songpa.go.kr",
    },
    {
        "title": "필사와 명상 모임",
        "agency_name": "서대문구 평생학습관",
        "region": "서울 서대문구",
        "description": "마음에 드는 책의 한 구절을 손으로 천천히 옮겨 적어봐요. 말없이 각자의 속도로 써 내려가는 조용한 시간이에요.",
        "image_url": "https://images.unsplash.com/photo-1517842645767-c639042777db?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.sdm.go.kr",
    },
    {
        "title": "사진 산책 동아리",
        "agency_name": "광진구 청년센터",
        "region": "서울 광진구",
        "description": "동네를 산책하며 마음에 드는 순간을 사진으로 남겨봐요. 잘 찍지 않아도 괜찮아요, 카메라를 들고 밖을 걸어본 것 자체가 의미 있어요.",
        "image_url": "https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.gwangjin.go.kr",
    },
    {
        "title": "아침 요가 교실",
        "agency_name": "강서구 문화체육센터",
        "region": "서울 강서구",
        "description": "기초 동작 위주로 무리 없이 진행되는 요가 수업이에요. 유연하지 않아도 괜찮아요, 내 호흡에 맞춰 천천히 따라가면 돼요.",
        "image_url": "https://images.unsplash.com/photo-1575052814086-f385e2e2ad1b?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.gangseo.seoul.kr",
    },
    {
        "title": "커피 핸드드립 클래스",
        "agency_name": "동작구 주민자치센터",
        "region": "서울 동작구",
        "description": "원두 선택부터 드립까지 차근차근 배워보는 클래스예요. 처음엔 서툴러도 괜찮아요, 직접 내린 커피 한 잔의 여유를 느껴봐요.",
        "image_url": "https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.dongjak.go.kr",
    },
    {
        "title": "다육식물 분갈이 교실",
        "agency_name": "구로구립 도서관",
        "region": "서울 구로구",
        "description": "여러 다육식물 중 마음에 드는 걸 골라 직접 분갈이해보는 교실이에요. 집에 작은 생명체 하나를 데려와보는 건 어때요.",
        "image_url": "https://images.unsplash.com/photo-1459156212016-c812468e2115?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.guro.go.kr",
    },
    {
        "title": "보드게임 사랑방",
        "agency_name": "관악구 청년공간",
        "region": "서울 관악구",
        "description": "규칙이 쉬운 보드게임으로 가볍게 어울려보는 모임이에요. 처음 만난 사람과도 게임을 매개로 자연스럽게 시간을 보낼 수 있어요.",
        "image_url": "https://images.unsplash.com/photo-1610890716171-6b1bb98ffd09?w=600",
        "contact": "02-XXX-XXXX",
        "apply_url": "https://www.gwanak.go.kr",
    },
]
